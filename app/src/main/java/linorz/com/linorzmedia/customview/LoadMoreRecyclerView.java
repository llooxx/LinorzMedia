...
public class LoadMoreRecyclerView extends RecyclerView {
    ...
    public class AutoLoadAdapter extends Adapter<ViewHolder> {
        ...
        public int getItemViewType(int position) {
            ...
            if (mIsShowFooter && footerPosition == position && mIsFooterEnable) {
                return TYPE_FOOTER;
            }
            /**
        ...
        public int getItemCount() {
            ...
            if (mIsShowFooter && mIsFooterEnable) count++;
...
//        super.swapAdapter(mAutoLoadAdapter, true);
    ...
    public void setFooterViewId(int viewId) {
        mIsShowFooter = true;
        footerViewId = viewId;
    }
    ...
    public void setOnPauseListenerParams(ImageLoader imageLoader, boolean pauseOnScroll, boolean pauseOnFling) {
        super.addOnScrollListener(new AutoLoadScrollListener(imageLoader, pauseOnScroll, pauseOnFling) {
            @Override
            public void onScrolled(RecyclerView recyclerView, int dx, int dy) {
                if (null != mListener && mIsFooterEnable && !mIsLoadingMore && dy > 0) {
                    super.onScrolled(recyclerView, dx, dy);
